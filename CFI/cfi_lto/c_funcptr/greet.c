...
typedef struct Person_ {
  int age;
  char* name;
  void (*greet)(struct Person_*, struct Person_*);
} Person;

typedef struct Shadow_ {
  int height;
  char* belong_to;
  void (* imitate)(struct Shadow_*, struct Shadow_*);
} Shadow;
...
void pop_shell_medium(void* a, void* b) {
  pop_shell();
}
void pop_shell_shadow(Shadow* target, Shadow* myself) {
  pop_shell();
}
...
void vuln(Person* pp) {
  ...
  printf("You are allowed to change the 'greet' function\n");
  printf(" callsite [type: (void)(Person*,Person*)] ====\n");
  printf("pop_shell [type: (void)(void           )]: %p\n", pop_shell);
  printf("pop_shell [type: (void)(void*,  void*  )]: %p\n", pop_shell_medium);
  printf("pop_shell [type: (void)(Shadow*,Shadow*)]: %p\n", pop_shell_shadow);
  printf("pop_shell [type: (void)(Person*,Person*)]: %p\n", pop_shell_advanced);
